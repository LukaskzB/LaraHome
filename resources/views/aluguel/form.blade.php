        ...
        <form action="{{ $action }}" method="POST" class="col">
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <input name="tamanho" id="tamanho" type="number" class="form-control" placeholder="Tamanho útil"
                        required value="@if (!empty(old('tamanho'))){{old('tamanho')}}@elseif(!empty($aluguel->tamanho)){{$aluguel->tamanho}}@endif">
                </div>
                <div class="col-md-2">
                    <label for="comodos" class="form-label">Quantidade de cômodos</label>
                    <input name="comodos" id="comodos" type="number" class="form-control"
                        placeholder="Quantidade de cômodos" required value="@if (!empty(old('comodos'))){{old('comodos')}}@elseif(!empty($aluguel->comodos)){{$aluguel->comodos}}@endif">
                </div>
                <div class="col-md-2">
                    <label for="banheiros" class="form-label">Quantidade de banheiros</label>
                    <input name="banheiros" id="banheiros" type="number" class="form-control"
                ...
                <div class="col-md-2">
                    ...
                    <input name="dormitorios" id="dormitorios" type="number" class="form-control"
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input name="carros" id="carros" type="number" class="form-control"
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input name="valor" id="valor" type="number" class="form-control" placeholder="Valor em reais" required

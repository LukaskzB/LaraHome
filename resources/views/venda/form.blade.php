        ...
        <form action="{{ $action }}" method="POST" class="col">
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" id="tamanho" name="tamanho" placeholder="Tamanho útil" required
                        value="@if (!empty(old('tamanho'))) {{ old('tamanho') }} @elseif (!empty($venda->tamanho)){{ $venda->tamanho }} @endif">
                </div>
                <div class="col-md-2">
                    <label for="comodos" class="form-label">Quantidade de cômodos</label>
                    <input type="text" class="form-control" id="comodos" name="comodos" placeholder="Quantidade de cômodos"
                        required value="@if (!empty(old('comodos'))) {{ old('comodos') }} @elseif (!empty($venda->comodos)){{ $venda->comodos }} @endif">
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="valor" name="valor" placeholder="Valor do imóvel em reais"
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" id="carros" name="carros"
